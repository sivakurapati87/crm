...
! function ($) {
    ...
    BootstrapTable.prototype.onSearch = function (event) {
        ...
        this.selectedFilterControl = event.handleObj.selector;
    ...
    BootstrapTable.prototype.initSearch = function () {
        ...
        if (this.options.sidePagination !== 'server') {
            ...
            if(that.selectedFilterControl == 'select'){
        		that.options.strictSearch = true;
        	}else{
        		that.options.strictSearch = false;
        	}
    ...
    var createControls = function (that, header) {
        ...
        $.each(that.columns, function (i, column) {
            ...
            if (!column.filterControl) {
                html.push('<div style="height: 23px;"></div>');
            } else {
                ...
                switch (column.filterControl.toLowerCase()) {
                    case 'input':
                        html.push(sprintf('<input type="text" class="form-control rowhdinput" style="width: 100%; visibility: %s">', isVisible));
                        break;
                    case 'select':
                        html.push(sprintf('<select class="%s form-control" style="width: 100%; visibility: %s"><option value="">Select</option></select>',
